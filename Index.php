  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav ms-auto">
        ...
        <a class="btn tombol-button-register text-dark" href="SignUpPeserta.php" role="button">Register</a>
        </li>
      </ul>
    </div>
  </div>
      ...
      <h4 class="judul-login mt-1 mb-5">SMA 2 KOTA MOJOKERTO</h4>
          ...
          <div class = "col-md-6">
              ...
              <form action = "cek_Index.php" method = "post">
                  ...
                  <input class = "btn btn-class" type  = "submit" name = "login" value = "Login"> 
              </form>
          </div>
        </div>
    </div>                   
