...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="data-akun-peserta.php">Data Akun</a>
          </li>
          <li class="nav-item">
  ...
  <section class="content">
    <div class="box">
      ...
      <?php
          $no = 1;
          $list_peserta = mysqli_query($conn, "SELECT * FROM tb_user WHERE level='user'");
          ...
          ?>
            <tr>
              ...
              <td>
                <a class="btn btn-hapus bg-primary" href="hapus-akun.php?id=<?php echo $row['id_user'] ?>" onclick="return confirm('Yakin ?')">Hapus</a>
              </td>
            </tr>
      <?php } ?>
          </tbody>
