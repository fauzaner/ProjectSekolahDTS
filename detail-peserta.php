...
<body>
  ...
  if (isset($_POST["submit"])) {
    ...
    $conn->query("UPDATE tb_pendaftaran SET status_siswa = '$status_siswa' WHERE id_pendaftaran = '" . $_GET['id'] . "'");
  ...
  <form action="" method="post">
    <div class="form-group row">
      ...
      <div class="col-75">
        <select style="width: 375px;  padding: 12px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box; background-color: #F8F8FF; resize: vertical;" name="status_siswa">
      ...
      <div class="col-sm-5">
        <input class="btn btn-primary rounded-pill" type="submit" name="submit" value="submit">
      </div>
  </form>
