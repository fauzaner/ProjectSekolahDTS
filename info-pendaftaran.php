...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="info-pendaftaran.php">Info Pendaftaran</a>
        </li>
        <li class="nav-item">
  ...
  <div class="form-group row">
            ...
            <a class="btn btn-detail bg-primary col-sm-5 ml-5 mr-5 mb-5">Cetak Bukti Pendaftaran</a>
  </section>
